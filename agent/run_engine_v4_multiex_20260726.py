...
with open('ma_slope_case3_ENGINE_v4_multiex_20260726.json', 'w', encoding='utf-8') as f:
    json.dump(result, f, indent=2, default=str, ensure_ascii=False)
print('Guardado: ma_slope_case3_ENGINE_v4_multiex_20260726.json', flush=True)
