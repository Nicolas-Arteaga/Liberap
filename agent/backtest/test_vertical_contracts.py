...
from backtest import cross_venue_research, forced_flow_research, funding_research, oi_research
...
class VerticalEvidenceContracts(unittest.TestCase):
    def test_metrics_include_execution_quality_fields(self):
        ...
        for module in (funding_research, oi_research, forced_flow_research, cross_venue_research):
