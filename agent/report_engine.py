            ...
            self.append_trade_metric_event(
                {
                    ...
                    "symbol": symbol,
                    "strategy_profile_id": local_pos_data.get("strategy_profile_id"),
                    "strategy_name": local_pos_data.get("strategy_name"),
                    "strategy_version": local_pos_data.get("strategy_version"),
                    "result": status_str,
