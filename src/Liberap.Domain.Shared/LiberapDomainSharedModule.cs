...
public class LiberapDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LiberapGlobalFeatureConfigurator.Configure();
        LiberapModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LiberapDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LiberapResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Liberap");

            options.DefaultResourceType = typeof(LiberapResource);
        ...
        {
            options.MapCodeNamespace("Liberap", typeof(LiberapResource));
        });
    }
}
