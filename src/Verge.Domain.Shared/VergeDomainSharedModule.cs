...
public class VergeDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        VergeGlobalFeatureConfigurator.Configure();
        VergeModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<VergeDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<VergeResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Verge");

            options.DefaultResourceType = typeof(VergeResource);
        ...
        {
            options.MapCodeNamespace("Verge", typeof(VergeResource));
        });
    }
}
