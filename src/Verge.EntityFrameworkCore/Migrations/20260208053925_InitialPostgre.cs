    ...
    public partial class InitialPostgre : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TradingStrategyId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeName = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TradingAlerts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfitPotential = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraderProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    DirectionPreference = table.Column<int>(type: "integer", nullable: false),
                    SelectedCryptosJson = table.Column<string>(type: "text", nullable: false),
                    Leverage = table.Column<int>(type: "integer", nullable: false),
                    Capital = table.Column<decimal>(type: "numeric", nullable: false),
                    RiskLevel = table.Column<int>(type: "integer", nullable: false),
                    AutoStopLoss = table.Column<bool>(type: "boolean", nullable: false),
