...
namespace Verge.Migrations.Trading
{
    ...
    [Migration("20260913041508_AddUseTrailStopToStrategyProfile")]
    partial class AddUseTrailStopToStrategyProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verge.Trading.AlertHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("ActualPnlPct")
                        .HasColumnType("decimal(18,8)");

                    b.Property<string>("AlertTier")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.Property<decimal>("ExpectedDrawdownPct")
                        .HasColumnType("decimal(18,8)");
                    ...
                    b.Property<int?>("TimeToResolutionMinutes")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("AlertTier");
            ...
            modelBuilder.Entity("Verge.Trading.AnalysisLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TraderProfileId");

                    b.HasIndex("TradingSessionId");

                    b.ToTable("AnalysisLogs", (string)null);
                });

            modelBuilder.Entity("Verge.Trading.BacktestResult", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verge.Trading.DecisionEngine.StrategyCalibration", b =>
                {
                    ...
                    b.Property<float>("InstitutionalMultiplier")
                        .HasColumnType("real");
                    ...
                    b.Property<float?>("TrailingMultiplier")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Verge.Trading.DecisionEngine.WhaleMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("PriceAfter4h")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("WasMarketMover")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("WhaleMovements", (string)null);
                });
            ...
            modelBuilder.Entity("Verge.Trading.ExchangeConnection", b =>
                {
                    ...
                    b.ToTable("ExchangeConnections", (string)null);
                });

            modelBuilder.Entity("Verge.Trading.Optimization.TemporalOptimizationResult", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verge.Trading.SimulatedTrade", b =>
                {
                    ...
                    b.Property<string>("ExclusionTag")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal?>("Ma7DistancePctAtEntry")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal?>("MaxAdversePrice")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("MaxFavorablePrice")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("MaxSlProgressPct")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("MaxTpProgressPct")
                        .HasColumnType("numeric");
                    ...
                    b.Property<Guid?>("StrategyProfileId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("TpProgressPct")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Verge.Trading.StrategyProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("BroadcastToBinance")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("ExtremeRsiVeto")
                        .HasColumnType("boolean");
                    ...
                    b.Property<float>("LseMaxEntrySlippagePct")
                        .HasColumnType("real");

                    b.Property<decimal>("MarginPerTrade")
                        .HasColumnType("decimal(18,2)");

                    b.Property<float>("MaxEntrySlippagePct")
                        .HasColumnType("real");

                    b.Property<float>("MaxMa7DistancePct")
                        .HasColumnType("real");

                    b.Property<float>("MaxNexusSignalAgeSeconds")
                        .HasColumnType("real");

                    b.Property<int>("MaxOpenPositions")
                        .HasColumnType("integer");

                    b.Property<float>("MaxRsiLong")
                        .HasColumnType("real");

                    b.Property<int>("MaxTradeDurationCandles")
                        .HasColumnType("integer");

                    b.Property<float>("MinConfluenceScore")
                        .HasColumnType("real");

                    b.Property<float>("MinEstimatedRangePct")
                        .HasColumnType("real");

                    b.Property<float>("MinNexusConfidence")
                        .HasColumnType("real");

                    b.Property<float>("MinRR")
                        .HasColumnType("real");

                    b.Property<float>("MinRsiShort")
                        .HasColumnType("real");

                    b.Property<float>("MinSlDistancePct")
                        .HasColumnType("real");

                    b.Property<float>("MinTpDistancePct")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("NexusMaxPriceDriftPct")
                        .HasColumnType("real");

                    b.Property<string>("PatternParamsJson")
                        .HasColumnType("text");

                    b.Property<bool?>("RequireMacdPositive")
                        .HasColumnType("boolean");

                    b.Property<float>("SlMultiplier")
                        .HasColumnType("real");
                    ...
                    b.ToTable("StrategyProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Verge.Trading.TraderProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verge.Trading.TradingAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TradingAlerts", (string)null);
                });

            modelBuilder.Entity("Verge.Trading.TradingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("EntryDayOfWeek")
                        .HasColumnType("integer");

                    b.Property<int?>("EntryHour")
                        .HasColumnType("integer");

                    b.Property<decimal?>("EntryPrice")
                        .HasColumnType("numeric");

                    b.Property<string>("EvaluationHistoryJson")
                        .HasColumnType("text");
                    ...
                    b.Property<int?>("InitialConfidence")
                        .HasColumnType("integer");

                    b.Property<int?>("InitialRegime")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("InitialVolatility")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("InitialVolumeMcapRatio")
                        .HasColumnType("numeric");

                    b.Property<string>("InitialWeightedScoresJson")
                        .HasColumnType("text");
                    ...
                    b.Property<long?>("LastEvaluationTimestamp")
                    ...
                    b.Property<int>("PartialTpsCount")
                        .HasColumnType("integer");

                    b.Property<int?>("SelectedDirection")
                        .HasColumnType("integer");

                    b.Property<int?>("SelectedStyle")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("StageChangedTimestamp")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Verge.Trading.TradingSignal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("EquityAfter")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Verge.Trading.TradingStrategy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<bool>("AutoStopLoss")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("CustomSymbolsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("DirectionPreference")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SelectedCryptosJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("StyleParametersJson")
                        .HasColumnType("text");
